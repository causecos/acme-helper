...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix='acme-v18-review-') as tmp:
        ...
        for lang in ('en','zh-TW'):
            ...
            p=call(['--help'],e)
            t.check('round1-correctness','help-'+lang,p.returncode==0 and 'acme issue' in p.stderr and 'acme certs' in p.stderr)
        ...
        t.check('ablation','remove-catalog-safe-english-fallback',p.returncode==0 and 'catalog unavailable' in p.stderr and 'acme issue' in p.stderr)
