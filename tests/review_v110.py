...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix='acme-v110-review-') as tmp:
        ...
        t.check('correctness','version-and-core-hash-present','helper_version=1.11.1' in text and 'core_sha256='+hashlib.sha256((ROOT/'acme_cli.py').read_bytes()).hexdigest() in text)
